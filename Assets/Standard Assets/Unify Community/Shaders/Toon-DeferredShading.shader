// -----------------------------------------------------------------------
// Original code by Unity.  This modification contains suggestions from David Leon:
// http://gamasutra.com/blogs/DavidLeon/20150702/247602/NextGen_Cel_Shading_in_Unity_5.php
// -----------------------------------------------------------------------
Shader "Hidden/Toon-DeferredShading" {
Properties {
	_LightTexture0 ("", any) = "" {}
	_LightTextureB0 ("", 2D) = "" {}
...
half4 CalculateLight (unity_v2f_deferred i)
{
	...
	// The following lines handle the light directions, giving the toon look
	if (light.ndotl <= 0.0)
	{
		light.ndotl = 0;
	}
